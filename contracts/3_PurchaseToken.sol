...
contract MiTokenParaVenta is ERC20, AccessControl {
    ...
    function purchaseFixRate(uint256 _usdcAmount) external {
        ...
        uint256 _balanceUsdc = usdc.balanceOf(msg.sender);
        require(_balanceUsdc >= _usdcAmount, "No tiene suficiente UDSC");
        ...
        uint256 permit = usdc.allowance(msg.sender, address(this));
        require(permit >= _usdcAmount, "No tiene suficiente permiso");
